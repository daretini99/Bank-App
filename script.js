...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-03-09T07:42:02.383Z',
    '2023-03-08T09:15:04.904Z',
    '2023-03-07T10:17:24.185Z',
    '2023-03-06T14:11:59.604Z',
...
// Functions
//FORMATING DATES FOR TRANSACTIONS
...
const startLogoutTimer = function () {
  ...
  //Call timer every second and immediately
  displayTime();
  const timer = setInterval(displayTime, 1000);
  return timer;
  //When time is at 0, stop timer and log user out
};
...
labelLogout.addEventListener('click', function () {
  logout();
  clearInterval(timer);
});
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    const dateFormated = new Intl.DateTimeFormat(locale, options).format(now);
